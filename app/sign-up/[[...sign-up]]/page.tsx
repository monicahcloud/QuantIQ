      ...
      <section className="relative hidden overflow-hidden bg-[#071d4e] px-12 py-10 text-white lg:flex lg:flex-col">
        ...
        <div className="relative z-10 my-auto max-w-xl">
          ...
          <h1 className="mt-5 text-5xl font-black leading-tight tracking-[-0.04em]">
            Build better lessons and support every student.
          </h1>

          <p className="mt-6 text-lg leading-8 text-blue-100/80">
            Create your educator account and begin your 14-day trial of the
            complete QuantIQ teaching workspace.
          </p>
        </div>
      ...
      <section className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <SignUp
            ...
            routing="path"
            signInUrl="/sign-in"
            forceRedirectUrl="/educator-studio/onboarding"
            appearance={{
              elements: {
                rootBox: "w-full",
